---
name: brainstorm-para-plano
description: Transforma pedido vago ou aberto em plano executável, explorando a intenção antes de escrever código. Use quando o pedido admitir mais de uma interpretação razoável ("adiciona notificações", "melhora o dashboard"). Sugerir proativamente no INÍCIO de qualquer feature nova ou pedido amplo.
---

# Brainstorm para plano
