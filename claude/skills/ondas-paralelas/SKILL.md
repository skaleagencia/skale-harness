...
description: Transforma uma lista de tarefas em ondas de execução paralela seguras, sem colisão de arquivo nem disputa de commit entre subagentes. Use quando houver 3+ tarefas independentes vindas de um plano, epic ou lote de correções. Sugerir proativamente logo DEPOIS de um plano ser aprovado.
---
