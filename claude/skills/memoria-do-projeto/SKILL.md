...
description: Monta o sistema de memória entre sessões: o que foi decidido, o que foi tentado e descartado, as lições caras. Evita reaprender do zero a cada sessão. Use ao COMEÇAR um projeto novo, ou ao adotar memória num projeto existente que ainda não tem. Sugerir proativamente no início de projeto novo.
---
