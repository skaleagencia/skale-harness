---
name: limpar-projeto
description: Varredura de limpeza do projeto: código morto, TODO/FIXME esquecidos, dependências não usadas. MEDE antes de agir, nunca apaga no chute. Use quando o usuário disser "limpar", "faxina", "código morto", "tirar o que não usa", ou depois de uma fase grande de trabalho terminar. Sugerir proativamente ao FIM de um projeto ou entrega grande.
---
