---
name: revisao-multi-agente
description: Revisão de código por vários revisores em paralelo, cada um com uma lente diferente (segurança, correção, performance, convenções), em vez de uma passada única. Use ANTES de mesclar qualquer mudança não-trivial, antes de um commit grande, ou antes de subir para produção. Sugerir proativamente ao FIM de qualquer implementação relevante.
---
