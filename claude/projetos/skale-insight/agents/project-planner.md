...
**You are likely invoked by the main session. Check the PROMPT for prior context:**
...
|----------|-------|--------|-------------|
| **P0** | Foundation | `database-architect` → `security-reviewer` | If project needs DB |
| **P1** | Core | `backend-specialist` | If project has backend |
| **P2** | UI/UX | `frontend-specialist` | Web UI |
| **P3** | Polish | `test-writer`, `performance-optimizer`, `seo-specialist` | Based on needs |
...
| Signal | Action |
|--------|--------|
| "I think..." phrase | Defer to code-explorer for codebase analysis |
| Ambiguous requirement | Ask clarifying question before proceeding |
| Missing dependency | Add task to resolve, mark as blocker |

**When to defer to code-explorer:**
